...
static const char kBlitFragmentGlsl[] =
    ...
    "    vec2 uvOffset;  /* (cropX/srcW, cropY/srcH)             */\n"
    "    vec2 uvStep;    /* (cropW/(outW*srcW), cropH/(outH*srcH)) */\n"
    "} pc;\n"
    ...
    "         * uvOffset and uvStep are precomputed on the host so the\n"
    "         * per-fragment math collapses to two multiply-adds. */\n"
    "        vec2 uv = pc.uvOffset + gl_FragCoord.xy * pc.uvStep;\n"
